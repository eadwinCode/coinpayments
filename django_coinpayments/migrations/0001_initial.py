# Generated by Django 2.2.6 on 2019-11-11 16:27
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkout_url', models.URLField(verbose_name='Checkout Url')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('currency_original', models.CharField(choices=[('BCH', 'Bitcoin Cash'), ('BTC', 'Bitcoin'), ('DASH', 'Dash'), ('ETH', 'Ether'), ('USD', 'USD')], default='USD', max_length=8, verbose_name='Original currency')),
                ('currency_paid', models.CharField(choices=[('BCH', 'Bitcoin Cash'), ('BTC', 'Bitcoin'), ('DASH', 'Dash'), ('ETH', 'Ether'), ('USD', 'USD')], max_length=8, verbose_name='Payment currency')),
                ('amount', models.DecimalField(decimal_places=18, max_digits=65, verbose_name='Amount')),
